...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBtn2Clicked(View v){
        // 테이블이 없을때만 생성함
        String sql = "create table if not exists customer (name text, " +
    ...
    public void onBtn3Clicked(View v){
        String sql1 = "insert into customer " +
                "(name, age, mobile) values ('김선호', 25, '010-1111-1111') ";

        String sql2 = "insert into customer " +
                "(name, age, mobile) values ('옹성우', 27, '010-2222-2222') ";
